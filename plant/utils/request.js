...
Request.syncano = syncano({
  apiKey: process.env.HACKLAG_SYNCANO_API_KEY,
  userKey: process.env.HACKLAG_SYNCANO_USER_KEY,
  defaults: {
    instanceName: process.env.HACKLAG_SYNCANO_INSTANCE,
  },
}).setInstanceName(process.env.HACKLAG_SYNCANO_INSTANCE);
